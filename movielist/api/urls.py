...
from movielist.api.views import WatchListAV,WatchListGV,WatchListDetails,StreamViewSets,ReviewList,ReviewDetail,ReviewCreate,UserReview
...
urlpatterns = [
    ...
    path('list2/',WatchListGV.as_view(),name='movie'),
